...
-- UNION KULLANIMI 
-- iki sorgudaki field sayısı yani sütun sayısı aynı olmalı. Iki sorguyu tekrarli ifadeler varsa teke dusurerek verir.
...
-- UNION KULLANIMI Iki tablodan data birleştirme
