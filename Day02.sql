...
insert into ogrenciler7 (ogrenci_no, soyisim, not_ort) values ('1234569', 'Can', 55.5); -- not null constraint
...
(
adres_id varchar(30), sokak varchar(30), cadde varchar(30), sehir varchar(30),
FOREIGN KEY (adres_id) REFERENCES calisanlar(id)
);

INSERT INTO calisanlar VALUES ('10002', 'Mehmet Yılmaz', 12000, '2018-04-14');
INSERT INTO calisanlar VALUES ('10008', null, 5000, '2018-04-14');
INSERT INTO calisanlar VALUES ('10010', 'Mehmet Yılmaz', 5000, '2018-04-14'); -- unique constraint
...
insert into calisanlar1 values ('10002', 'Mehmet Yilmaz', 900, '2018-04-14'); -- check constraint
