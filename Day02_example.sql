...
insert into sehirler values('Eskisehir', 123, 2700000);
insert into sehirler(alan_kodu, nufus) values(237, 3000000); --not null constraint, bu yuzden eklenemez
...
insert into ilceler values('Kecioren', 239, 270000); --parent table da primary key de bu deger yok, bu yuzden eklenemez
insert into ilceler values('Beylikduzu', null, 270000);
insert into ilceler values('Beylikduzu', null, 270000);
insert into ilceler values('Besiktas', null, 650000);
select * from ilceler;
select * from sehirler;
