...
-- child table silinmeden prent table silinemez.
...
CREATE TABLE child2
(
ted_vergino int, urun_id int, urun_isim VARCHAR(50),
musteri_isim VARCHAR(50), CONSTRAINT fk FOREIGN KEY(ted_vergino) REFERENCES parent2(vergi_no) ON DELETE CASCADE
);
...
drop table parent2 cascade; -- on delete cascade sayesinde child table silinmeden parent tablo silinebildi, ama child table silinmez.
