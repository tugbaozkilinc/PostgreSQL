...
select sirketler.sirket_isim, siparisler.siparis_id, siparisler.siparis_tarihi from siparisler 
inner join sirketler on sirketler.sirket_id=siparisler.sirket_id;
