...
-- Eger iki sutunun verilerini birlestirmek istersek concat || sembolu kullanırız
-- 1. yol:
...
select * from insanlar order by isim, soyisim;
...
-- Eger sutun uzunluguna gore siralamak istersek LENGTH komutu kullaniriz ve yine uzunlugu buyukten kucuge siralamak istersek  sonuna DESC komutunu ekleriz
